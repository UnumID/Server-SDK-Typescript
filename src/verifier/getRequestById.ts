 ...
 * @returns
 */
export async function getPresentationRequest (authorization: string, id: string, version = sdkMajorVersion): Promise<UnumDto<PresentationRequestEnriched[]>> {
  ...
  try {
    ...
    return { body: resp.body, authToken };
  } catch (e) {
