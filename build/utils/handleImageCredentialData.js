 ...
 * @throws CustError
 */
function handleImageCredentialData(data) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    image = data.image;
                    if (!!isBase64_1.isBase64(image)) return [3 /*break*/, 3];
                ...
                case 2: throw new error_1.CustError(400, "Invalid " + data.type + " image data");
                case 3: return [2 /*return*/, data];
            }
        });
    });
}
exports.handleImageCredentialData = handleImageCredentialData;
//# sourceMappingURL=handleImageCredentialData.js.map