    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 4:
                ...
                isPresentationVerified_1 = false;
                ...
                for (_i = 0, publicKeyInfoList_1 = publicKeyInfoList; _i < publicKeyInfoList_1.length; _i++) {
                    ...
                    isPresentationVerified_1 = verify_1.doVerify(proof.signatureValue, bytes, publicKey, encoding);
                    if (isPresentationVerified_1)
                        break;
                }
                return [3 /*break*/, 7];
            case 5:
