 ...
 */
export declare const verifyEncryptedPresentation: (authorization: string, encryptedPresentation: EncryptedData, verifierDid: string, encryptionPrivateKey: string) => Promise<VerifierDto<Receipt>>;
