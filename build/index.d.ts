...
export { registerIssuer, issueCredentials, reEncryptCredentials, updateCredentialStatuses, verifySubjectCredentialRequests, revokeAllCredentials, handleSubjectCredentialRequests, registerVerifier, sendEmail, sendRequest, sendSms, verifyPresentation, checkCredentialStatuses, getPresentationRequestByUuid, getPresentationRequest, UnumDto, RegisteredVerifier, VerifiedStatus, Presentation, RegisteredIssuer, CredentialSubject, DecryptedPresentation, CredentialStatusInfo, HandleSubjectCredentialRequestsOptions, HandleSubjectCredentialRequestsReEncryptOptions, CustError, Proof, Credential, CredentialInfo, extractCredentialData, extractCredentialInfo, extractCredentialType, extractPresentationData, verifySignedDid, createProof, convertCredentialSubject, doVerify, doDecrypt, doEncrypt };
